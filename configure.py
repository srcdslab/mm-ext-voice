...
parser.options.add_argument('--dynohook-path', type=str, dest='dynohook_path', default=None,
                      help='Path to DynoHook')
parser.options.add_argument('--celt-path', type=str, dest='celt_path', default=None,
                      help='Path to celt')
